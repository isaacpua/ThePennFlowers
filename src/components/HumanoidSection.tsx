          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: "url('/ThePennFlowers/background-section1.png')",
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-pulse-900/40 to-dark-900/80"
                style={{
                  backgroundImage: "url('/ThePennFlowers/background-section2.png')",
                  backgroundSize: "cover",
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-pulse-900/40 to-dark-900/80"
                style={{
                  backgroundImage: "url('/ThePennFlowers/background-section3.png')",
                  backgroundSize: "cover",
